...
function SearchResults() {
    ...
    return (
        <div className="fixed inset-0 z-[110] bg-black overflow-y-auto custom-scrollbar" data-lenis-prevent>
                    ...
                    {!query ? (
                        ...
                        >
                            ...
                            <section>
                                ...
                                <div className="flex md:grid md:grid-cols-4 gap-4 md:gap-8 overflow-x-auto md:overflow-visible pb-4 md:pb-0 scrollbar-none">
                                    {CATEGORY_DISCOVERY.map((cat, i) => (
                                        ...
                                        >
                                            <div className={cn(
                                                "w-20 h-20 md:w-full md:h-auto md:aspect-square rounded-full overflow-hidden border-2 border-white/5 relative bg-gradient-to-br transition-all duration-500 group-hover:scale-105 group-hover:border-accent-neon",
                                                cat.color
                                            )}>
                                                <img
                                                    src={cat.image}
                                                ...
                                                <div className="absolute inset-0 flex items-center justify-center">
                                                    <span className="text-[9px] md:text-lg font-black text-white tracking-widest group-hover:scale-110 transition-transform">{cat.name}</span>
                                                </div>
                                            </div>
                                        </motion.button>
                                    ))}
